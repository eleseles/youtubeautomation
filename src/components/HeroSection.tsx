      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
          ...
          <h1 className="text-4xl md:text-7xl font-serif font-bold text-gray-900 leading-[1.2] md:leading-[1.1] tracking-tighter">
            <span className="text-olive-green italic font-medium">AI YouTube Automation</span>: Scale Your <span className="text-olive-green italic font-medium">Automated YouTube Channel</span>
          </h1>
